...
- MPEG_FRAME->MPEG_HEADER有一位[private_bit](https://www.cnpanda.net/ctf/342.html)是保留位可以用于隐写
...
#### [Volatility](https://www.volatilityfoundation.org)，[常用指令](https://mengsec.com/2018/10/20/CTF-Volatility/,https://www.freebuf.com/column/152545.html)
...
volatility -f mem.data --profile=Win7SP1x64 filescan | grep Interfaces #查文件列表
...
```
cd D:\ctf\tools\forensics\FTK Imager 4.2.1\FTK Imager
```
