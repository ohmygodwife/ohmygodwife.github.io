...
| class                                                        | CA FE BA BE 00 00 00 34（前4byte magic number，2byte次版本，2byte主版本） |                                               |
...
| 10   | 2    | frFileTime                                                   |
| 12   | 2    | frFileDate                                                   |
| 14   | 4    | frCrc：frData的CRC值。CRC错误会导致无法解压，010Editor全选frData，copy as hex，粘贴到CyberChef，选择From Hex链接CRC-32 Checksum，计算得到正确的CRC。sample：misc04，wangding-2024 |
