...
利用IDA查看so文件的`JNI_OnLoad`函数的native函数定义，对应在Java端定义所有的函数。

```c
int __fastcall JNI_OnLoad(int a1)
{
    (v3 = "check", v4 = "(Ljava/lang/String;Ljava/lang/String;)I",v5 = check,
     v6 = "detect", v7 = "(Ljava/lang/String;Ljava/lang/String;)I", v8 = detect,
}
```

## PYC逆向

PyInstaller打包出来出来的exe会包含PyImport字符串（sample：来玩蛇吧，安恒月赛2019-01）
...
利用[uncompyle6](https://github.com/rocky/python-uncompyle6)反编译为py（[uncompyle2](http://www.cnblogs.com/pcat/p/5400911.html)仅能反编译python2*）
