...
1.[Network boot from Intel E1000](https://knowledge.broadcom.com/external/article/312552/disabling-network-boot-option-from-appea.html)：修改vmx文件，增加一行`ethernet0.opromsize = "0"`
