...
sample：[Ally](https://zhuanlan.zhihu.com/p/702904244)，CryptoCTF-2024
...
#### f(a+1,b)=f(a,b)+a, f(a,b+1)=f(a,b)-b

sample：[Bada](https://zhuanlan.zhihu.com/p/702904244)，CryptoCTF-2024
$$
f(a,b)=f(0,b)+0+1...+(a-1)=f(0,b)+a(a-1)/2\\
f(a,b)=f(a,0)-(0+1...+(b-1))=f(a,0)-b(b-1)/2\\
记f(0,0)=c，得：f(a,b)=a(a-1)/2-b(b-1)/2+c\\
给定f(x_0,y_0)求得c，对于z=f(x,y)=x(x-1)/2-y(y-1)/2+c\\
配方：8(z-c)=4x(x-1)-4y(y-1)=(2x-1)^2-(2y-1)^2=(2x-2y)(2x+2y-2)\\
即：2(z-c)=(x-y)(x+y-1)，对2(z-c)因式分解，记为：2(z-c)=st\\
得：x=(s+t+1)/2，y=(t-s+1)/2
$$

#### 找最小正整数c使得nc的二进制表示中1的个数最小，[sturdy-numbers](https://github.com/FinnLidbetter/sturdy-numbers)的msw

sample：[Ahoo](https://zhuanlan.zhihu.com/p/702904244)，CryptoCTF-2024
