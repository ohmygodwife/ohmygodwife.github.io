...
[sqlmap](http://sqlmap.org/)命令[常用参数](https://www.cnblogs.com/jerrylocker/p/10767304.html)：`sqlmap -u "url" [-r post.txt] -p "id,user-anget" --output-dir=./output --cookie=? --os-shell --technique=E --ignore-redirects --start=100 --stop=200`
