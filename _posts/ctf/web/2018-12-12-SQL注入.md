...
[sqlmap](http://sqlmap.org/)命令[常用参数](https://www.cnblogs.com/jerrylocker/p/10767304.html)：`sqlmap -u "url" --cookie=? --os-shell --technique=E --ignore-redirects --start=100 --stop=200`
